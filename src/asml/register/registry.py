...
class RegistryHandler:
  ...
  # you should connect to. Do not support failure of DS, FG nor DEPLOYER. Just Learners can fail
    ...
    try:
      if comp_type == ComponentType.DATASTREAM:
        ...
        with self._lock:
          ...
          if self._featgen:
            # tell the feature generator, to contact those learners
            self._notify(self._featgen, self._learners.keys())
          # tell the deployer that new clients are available
