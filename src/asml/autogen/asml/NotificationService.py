...
class Iface(asml.StreamService.Iface):
...
class Client(asml.StreamService.Client, Iface):
  def __init__(self, iprot, oprot=None):
    asml.StreamService.Client.__init__(self, iprot, oprot)
...
class Processor(asml.StreamService.Processor, Iface, TProcessor):
  def __init__(self, handler):
    asml.StreamService.Processor.__init__(self, handler)
